...
Examples:
  python scripts/pipeline.py --name Lan5
  python scripts/pipeline.py --name Lan6 --workflow run-batch --files-per-batch 1000
  python scripts/pipeline.py --name Lan7 --only-generate
  python scripts/pipeline.py --name Lan7 --only-download --run-id 12345678
  python scripts/pipeline.py --name Lan8 --workflow run
"""
